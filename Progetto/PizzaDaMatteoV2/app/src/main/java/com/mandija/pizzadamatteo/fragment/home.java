    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.btPutOrdine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(home.this).navigate(R.id.action_home_to_putOrdine);
            }
        });
        ...
        binding.btGetStats.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NavHostFragment.findNavController(home.this).navigate(R.id.action_home_to_getStats);
            }
        });
